...
void VaporTrail::_bind_methods() {
	...
	ClassDB::add_property("VaporTrail", PropertyInfo(Variant::INT, "num_points", PROPERTY_HINT_RANGE, "2,10000,1"), "set_num_points", "get_num_points");
	ClassDB::add_property("VaporTrail", PropertyInfo(Variant::FLOAT, "update_interval", PROPERTY_HINT_NONE, ""), "set_update_interval", "get_update_interval");
	ClassDB::add_property("VaporTrail", PropertyInfo(Variant::FLOAT, "randomness", PROPERTY_HINT_NONE, ""), "set_randomness", "get_randomness");

	ADD_GROUP("Visual", "");
	ClassDB::add_property("VaporTrail", PropertyInfo(Variant::OBJECT, "material", PROPERTY_HINT_RESOURCE_TYPE, "Material"), "set_material", "get_material");
	ClassDB::add_property("VaporTrail", PropertyInfo(Variant::FLOAT, "size", PROPERTY_HINT_RANGE, "0.0,100.0,0.01"), "set_size", "get_size");
	ClassDB::add_property("VaporTrail", PropertyInfo(Variant::OBJECT, "size_curve", PROPERTY_HINT_RESOURCE_TYPE, "Curve"), "set_curve", "get_curve");
	ClassDB::add_property("VaporTrail", PropertyInfo(Variant::FLOAT, "minimum_onscreen_size", PROPERTY_HINT_RANGE, "0.0,100.0,0.01"), "set_minimum_onscreen_size", "get_minimum_onscreen_size");
	ClassDB::add_property("VaporTrail", PropertyInfo(Variant::OBJECT, "color_gradient", PROPERTY_HINT_RESOURCE_TYPE, "Gradient"), "set_gradient", "get_gradient");
	ClassDB::add_property("VaporTrail", PropertyInfo(Variant::FLOAT, "uv_shift", PROPERTY_HINT_RANGE, "-100.0,100.0,0.001"), "set_uv_shift", "get_uv_shift");
	ClassDB::add_property("VaporTrail", PropertyInfo(Variant::INT, "uv_alignment", PROPERTY_HINT_ENUM, "Fixed,Rolling"), "set_uv_alignment", "get_uv_alignment");

	ADD_GROUP("Temporal", "");
	ClassDB::add_property("VaporTrail", PropertyInfo(Variant::OBJECT, "time_curve", PROPERTY_HINT_RESOURCE_TYPE, "Curve"), "set_time_curve", "get_time_curve");
	ClassDB::add_property("VaporTrail", PropertyInfo(Variant::OBJECT, "time_color_gradient", PROPERTY_HINT_RESOURCE_TYPE, "Gradient"), "set_time_color_gradient", "get_time_color_gradient");
	ClassDB::add_property("VaporTrail", PropertyInfo(Variant::FLOAT, "current_time", PROPERTY_HINT_RANGE, "0.0,1.0,0.01"), "set_current_time", "get_current_time");
}
...
bool VaporTrail::_set(const StringName &p_name, const Variant &p_value) {
	...
	if (p_name == StringName("config/geometry_nodepath")) {
		set_geometry_root(p_value);
		return true;
	}
	if (p_name == StringName("config/num_points")) {
		set_num_points(p_value);
		return true;
	}
	if (p_name == StringName("config/update_interval")) {
		set_update_interval(p_value);
		return true;
	}
	if (p_name == StringName("config/randomness")) {
		set_randomness(p_value);
		return true;
	}
	if (p_name == StringName("visual/material")) {
		set_material(p_value);
		return true;
	}
	if (p_name == StringName("visual/size")) {
		set_size(p_value);
		return true;
	}
	if (p_name == StringName("visual/size_curve")) {
		set_curve(p_value);
		return true;
	}
	if (p_name == StringName("visual/minimum_onscreen_size")) {
		set_minimum_onscreen_size(p_value);
		return true;
	}
	if (p_name == StringName("visual/color_gradient")) {
		set_gradient(p_value);
		return true;
	}
	if (p_name == StringName("visual/uv_shift")) {
		set_uv_shift(p_value);
		return true;
	}
	if (p_name == StringName("visual/uv_alignment")) {
